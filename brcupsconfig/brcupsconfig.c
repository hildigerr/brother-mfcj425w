...
#ifndef _MODEL_11_LINUX_DRIVER_	// Removed , 2012-02-02
#define MFC_J6310W	"mfcj6310w"
#define MFC_J6510DW	"mfcj6510dw"
#endif // end _MODEL_11_LINUX_DRIVER_
...
#ifdef _MODEL_11_LINUX_DRIVER_ // Added ,  2011-12-21
int exec_brprintconf(char *brprintconf,char *printer,char* rcfilepath);
#else   //  _MODEL_11_LINUX_DRIVER_
...
#if 0	/*MODEL_9. Chenyipan. 20080715*/
  //************************************
...
#endif // Ended _MODEL_11_LINUX_DRIVER_ 
...
int add_command_list_brcommand_sub(char  *command){
  ...
  option[strlen(option)] = 0;	/*MODEL_9. Chenyipan. 20080715*/
